...
public class MilestoneController {
    ...
    @GetMapping("/{domainId}")
    public ResponseEntity<List<MilestoneResponse>> getMilestones(@PathVariable UUID domainId, @CurrentUser UUID userId) {
    ...
    public ResponseEntity<MilestoneResponse> updateStatus(@PathVariable UUID milestoneId, @RequestParam MilestoneStatus status, @CurrentUser UUID userId) {
